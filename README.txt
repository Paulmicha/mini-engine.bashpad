 ...
 *  but it could be an intersting exercise to rebuild it in "modern" PHP, using things like Symfony 2 or Laravel.
 *  
 *  Basically, this is a "museum" of various Php snippets from a few years back put together.
 *  I'm publishing this with GPL v2 license on Github because I've recently expanded it a bit and "cleaned up" the source code.
 *  
